...
And that's it! But wait, there's more. This works, but you can't really *share* a search query to someone else, I can share google links - [google.com/search?q=github](https://google.com/search?q=github)
I think that's kinda important, like, for times when I have to share [all my Rust blogs](/?q=#rust), it's just easier and convenient.
...
<a data-tip="<img width=700 src='https://us-east-1.tixte.net/uploads/img.dhravya.dev/l2z32l9dj0a.png'></img>" href="https://developer.mozilla.org/en-US/docs/Web/API/History_API">History API | MDN</a>
...
<a href="https://twitter.com/dhravyashah"><img src="https://img.shields.io/twitter/follow/dhravyashah?logo=twitter&style=for-the-badge" alt="Dhravya Shah" /></a>

Feel free to visit the repository for this blog here 
[![Dhravya Shah's blog](https://github-readme-stats.vercel.app/api/pin/?username=dhravya&repo=blog)](https://github.com/dhravya/blog)
